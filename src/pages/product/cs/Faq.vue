<template>
  <div class="container">
    <nav class="nav nav-pills nav-fill">
      <router-link class="nav-link" :to="{ name: 'Location'}">가게 정보</router-link>
      <router-link class="nav-link active" aria-current="page" :to="{ name: 'Faq'}">FAQ</router-link>
    </nav>
  </div>
  <div class="container faqinfo">
    <h1>FAQ</h1>
    <h5>자주 하는 질문들입니다.</h5>
  </div>
  <div class="container">
